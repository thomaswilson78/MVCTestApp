...
namespace MVCTestApp.Controllers
{
    public class CoursesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SectionID,CourseID,CourseName,ClassStartTime,ClassEndTime,CourseStartDate,CourseEndDate,CourseHours")] Course course)
        {
            if (ModelState.IsValid)
            {
